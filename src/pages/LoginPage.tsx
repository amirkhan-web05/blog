  ...
  return (
    <Box component='form' onSubmit={handleSubmit} className='container'>
      ...
      <Paper elevation={3} sx={{maxWidth:500, width:'100%', padding:5, margin:'0 auto'}}>
        ...
        <TextField type="password" value={form.password} onChange={e => setForm({...form, password:e.target.value})} sx={{margin:'10px 0'}} fullWidth label="Password" variant="outlined" />
